export const dataHun = {
  data: {
    appTitle: 'Receptjeim',
    menuItems: ['Kezdőlap', 'Receptjeim', 'Kedvenceim', 'Bevásárló Listám', 'Kategóriák', 'Profilom', 'Beállítások', 'Kijelentkezés', 'Admin', 'Hibajelentés', 'Impresszum', 'Ismerőseim', 'Keresés'],
    ...
    myRecipes: {
      newRecipe: {
        ...
        categoryItems: ['Egyik sem', 'Előétel', 'Szendvics', 'Leves', 'Saláta', 'Köret', 'Tészta', 'Pite', 'Pizza', 'Burger', 'Csirke', 'Pulyka', 'Kacsa', 'Vadétel', 'Sertés', 'Bárány', 'Marha', 'Fasírt', 'Hal', 'Tenger_gyümölcsei', 'Szósz', 'Vegetáriánus', 'Különlegesség', 'Desszert', 'Süti', 'Ital', 'Mentes_étel']
      },
      editRecipe: {
        title: 'Szerkesztés',
        saveChanges: 'Mentés',
